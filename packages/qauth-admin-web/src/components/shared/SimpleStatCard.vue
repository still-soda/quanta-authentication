...
<template>
   <div
      class="group flex items-center gap-4 py-5 px-6 bg-surface-0 dark:bg-surface-900 border border-surface-200 dark:border-surface-800 rounded-[14px]"
      :style="{
   ...
   >
      <div
         class="w-12 h-12 flex items-center justify-center rounded-xl bg-(--theme-bg) dark:bg-(--theme-bg-dark) text-(--theme-color) shrink-0 transition-all"
      >
      ...
      <div class="flex flex-col gap-0.5">
         ...
         <span class="text-[0.8125rem] font-medium text-surface-500 dark:text-surface-400">
            {{ stat.title }}
         </span>
      </div>
   </div>
