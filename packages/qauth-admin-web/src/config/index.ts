...
export const SIMPLE_STAT_COLORS = {
  orange: { color: 'var(--p-orange-500)', bg: 'var(--p-orange-50)', bgDark: 'rgba(251, 146, 60, 0.15)' },
  blue: { color: 'var(--p-blue-500)', bg: 'var(--p-blue-50)', bgDark: 'rgba(59, 130, 246, 0.15)' },
  green: { color: 'var(--p-green-500)', bg: 'var(--p-green-50)', bgDark: 'rgba(34, 197, 94, 0.15)' },
  purple: { color: 'var(--p-purple-500)', bg: 'var(--p-purple-50)', bgDark: 'rgba(168, 85, 247, 0.15)' },
  ...
  gray: { color: 'var(--p-surface-500)', bg: 'var(--p-surface-100)', bgDark: 'rgba(107, 114, 128, 0.15)' },
} as const;
